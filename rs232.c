...
int OpenComport(char comport[], int baudrate)
{
  ...
  switch(baudrate)
  {
    ...
    case 1000000 : baudr = B1000000;
                   break;
    default      : fprintf(stderr,"Error: invalid baudrate\n");
                   return(1);
                   break;
  }
  ...
  {
    close(Cport);
    fprintf(stderr,"Error: unable to read port settings\n");
    return(1);
  }
  ...
  {
    close(Cport);
    fprintf(stderr,"Error: unable to adjust portsettings ");
    return(1);
  }
...
int OpenComport(char comport[], int baudrate)
{
  ...
  {
	fprintf(stderr,"Error: unable to set %s dcb settings.\n",comport);
    CloseHandle(Cport);
    return(1);
  }
  ...
  {
	fprintf(stderr,"Error: unable to set %s cfg settings.\n",comport);
    CloseHandle(Cport);
    return(1);
  }
  ...
  {
	fprintf(stderr,"Error: unable to set %s time-out settings.\n",comport);
    CloseHandle(Cport);
    return(1);
  }
